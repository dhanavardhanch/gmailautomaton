...
3. **Fast Two-Phase Sync**: 
   ...
   - **Phase 2 (Background AI Enrichment)**: Heavy processing tasks (generating Gemini summaries, NVIDIA NIM classifications, text chunking, and embedding generation) run asynchronously after the response is sent using Next.js 15's `after()` API.
...
sequenceDiagram
    ...
    participant AI as Gemini & NIM Services
